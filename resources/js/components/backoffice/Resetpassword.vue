                ...
                <div class="card shadow sm">
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)" class="row" method="post">
							...
							<div class="form-group col-12 mb-2">
                                <label for="password" class="font-weight-bold">Confirm Password <i class="bi bi-asterisk text-danger small-font"></i></label>
...
export default {
    ...
    methods:{
		...
		async resetpassword(){
            ...
            await axios.post('/resetpassword',this.auth).then(({data})=>{
