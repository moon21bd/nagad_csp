                            ...
                            <div class="col-5">
                                <form ref="RoleForm" action="javascript:void(0)" @submit="saveUser" class="row"
                                    ...
                                    <div class="form-group col-12 mb-2">
                                        <label for="name" class="font-weight-bold col-12">User Name <i
                                            class="bi bi-asterisk text-danger small-font"></i></label>
                                    ...
                                    <div class="form-group col-12 mb-2">
                                        <label for="email" class="font-weight-bold">Email <i
                                            class="bi bi-asterisk text-danger small-font"></i></label>
                                        <input type="text" name="email" v-model="user.email" id="email"
                                               placeholder="Enter Email" class="form-control" :disabled="addform">
                                        <span v-if="errors.email" class="text-danger">{{ errors.email[0] }}</span>
                                    </div>
                                    <div class="form-group col-12 mb-2" :hidden="addform">
                                        <label for="password" class="font-weight-bold">Password <i
                                            class="bi bi-asterisk text-danger small-font"></i></label>
                                    ...
                                    <div class="form-group col-12 mb-2" :hidden="addform">
                                        <label for="password_confirmation" class="font-weight-bold">Confirm Password <i
                                            class="bi bi-asterisk text-danger small-font"></i></label>
                                        ...
                                        <span v-if="errors.password_confirmation"
                                              class="text-danger">{{ errors.password_confirmation[0] }}</span>
                                    </div>
                                    ...
                                    <div class="form-group col-12 mb-2 mt-2">
                                        ...
                                        <div class="d-flex">
                                            <div class="row">
                                                <div class="col-4 checkbox-inline" v-for="(role,key) in roles"
                                                     :key="key">
                                                    <label :for="role.name" class="">
                                                        <input type="checkbox" :value="role.id"
                                                               :checked="user.currentroles.indexOf(role.id) !== -1"
                                                               v-model="user.currentroles"> {{ role.name }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-12 mb-2 mt-2">
                                        <label for="permissions" class="font-weight-bold col-12">
                                            ...
                                            <p>Please check the special permissions other then role permissions you want
                                                to assign to this user</p>
                                        </label>
                                        <div class="d-flex">
                                            <div class="row">
                                                <div class="col-4 checkbox-inline"
                                                     v-for="(permission,key) in permissions" :key="key">
                                                    <label :for="permission.name" class="">
                                                        <input type="checkbox" :value="permission.id"
                                                               :checked="user.currentpermissions.indexOf(permission.id) !== -1"
                                                               v-model="user.currentpermissions"> {{ permission.name }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    methods: {
        ...
        editUser(id) {
            axios.post('/users/' + id).then(response => {
        ...
        async saveUser() {
            ...
            await axios.post('/usersdata/save', this.user).then(({data}) => {
