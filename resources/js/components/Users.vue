                                ...
                                >
                                    ...
                                    <div class="form-group col-12 mb-2 mt-2">
                                        ...
                                        >
                                            <h2>Assign Roles</h2>
                                            <p>
                                                Please check the roles which you
                                                want to assign to this user
                                            </p>
                                        </label>
                                        <div class="d-flex">
                                            <div class="row">
                                    ...
                                    <div class="form-group col-12 mb-2 mt-2">
                                        ...
                                        >
                                            ...
                                            <p>
                                                Please check the special
                                                permissions other then role
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            "
                                                            :checked="
                                                                user.currentpermissions.indexOf(
                                                                    permission.id
                                                                ) !== -1
                                                            "
                                                            v-model="
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.user.currentpermissions =
                        response.data.data.currentpermissions;
                    this.addform = true;
                })
                .catch((error) => {
                    console.log(error);
        ...
        async saveUser() {
            ...
            if (!this.addform) {
                ...
                if (!this.user.password_confirmation) {
                    ...
                    this.errors.password_confirmation = [
                        "Password confirmation did't match.",
                    ];
                    this.isError = true;
                } else {
                    this.errors.password_confirmation = "";
