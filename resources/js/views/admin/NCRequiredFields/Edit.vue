    ...
    <div>
        <form @submit.prevent="updateRequiredFieldsData">
            <div class="form-group">
                ...
                <select v-model="requiredFieldsConfigsData.call_type_id" @change="fetchCategories" required>
            ...
            <div class="form-group">
                ...
                <select v-model="requiredFieldsConfigsData.call_category_id" @change="fetchSubCategory" required>
            ...
            <div class="form-group">
                ...
                <select v-model="requiredFieldsConfigsData.call_sub_category_id" required>
            ...
            <div class="form-group">
                ...
                <input type="text" v-model="requiredFieldsConfigsData.input_field_name" class="form-control" id=""
                       placeholder="Enter Call Type Name">
            </div>
            <div class="form-group">
                <label for="exampleFormControlSelect1">Input Type</label>
                <select class="form-control" v-model="requiredFieldsConfigsData.input_type" id="">
            ...
            <div class="form-group">
                ...
                <input type="text" v-model="requiredFieldsConfigsData.input_value" class="form-control" id=""
                       placeholder="Enter Call Type Name">
            </div>
            <div class="form-group">
                <label for="name">Input Validation</label>
                <input type="text" v-model="requiredFieldsConfigsData.input_validation" class="form-control" id=""
                       placeholder="Enter Call Type Name">
            </div>
            <div class="form-group">
                <label for="exampleFormControlSelect1">Status</label>
                <select class="form-control" v-model="requiredFieldsConfigsData.status" id="status">
...
export default {
    ...
    methods: {
        ...
        async fetchCategories() {
            try {
                const response = await axios.get(`/get-category/${this.requiredFieldsConfigsData.call_type_id}`);
        ...
        async getSubCategoryById() {
            try {
                const response = await axios.get(`/call-sub-by-call-cat-id/${this.requiredFieldsConfigsData.call_type_id}/${this.requiredFieldsConfigsData.call_category_id}`);
        ...
        async fetchRequiredFieldsConfigs() {
            try {
                const response = await axios.get(`/required-fields-configs/${this.id}`);
        ...
        async updateRequiredFieldsData() {
            try {
                await axios.put(`/required-fields-configs/${this.id}`, this.requiredFieldsConfigsData);
