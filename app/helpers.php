...
if (!function_exists('responseSuccess')) {
     ...
     * @return JsonResponse
     */
    function responseSuccess($data = [], string $msg = 'Operation Successful', array $other = []): JsonResponse
    {
        $res = [
            'message' => $msg,
            'data' => $data,
...
if (!function_exists('responseFailed')) {
     ...
     * @return JsonResponse
     */
    function responseFailed(string $msg = 'Operation failed', int $statusCode = 400, $data = []): JsonResponse
    {
        if (config('app.debug')) {
